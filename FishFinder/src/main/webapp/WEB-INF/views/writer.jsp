					...
					<div class="question_box">
						<div class="board_write">
							<div class="title">
								...
								<dl class="title_flex">
									...
									<input class="title_type" name="article_title" type="text"
										style="border: none; background: transparent;" size=""
										placeholder="제목을 입력해주세요. (20자 이내)" maxlength="20"
							...
							<input value="${sessionScope.user_num}" type="hidden"
								...
								name="user_num">
							<div class="cont">
								<textarea name="article_content" class="write_content"
									placeholder="내용을 입력해주세요.(400자 이내 )" maxlength="400"></textarea>
							</div>
						...
						<nav>
							<ul>
								...
								<li><a href="/fish/view" class="icon solid fa-sign-out"><span
										class="label">Exit</span></a></li>
							</ul>
						</nav>
					</div>
					<nav>
