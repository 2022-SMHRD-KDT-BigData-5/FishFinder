								...
								<a href='javascript:open(${list.article_seq})'>
									<li class="board_list">
										<div class="preview_img">
											<img class="board_img" src="assets/css/images/img_test.jpg"
												onerror="">
										</div>
										<div class="board_tnd">
							...
							<div class="w100" style="padding-right: 10px">
								<select class="form-control form-control-sm" name="searchType"
									...
									<option value="article_title"
										${boardList.searchType eq 'article_title' ? 'selected' : ''}>제목</option>
									<option value="article_content"
										${boardList.searchType eq 'article_content' ? 'selected' : ''}>내용</option>
									<option value="title_content"
										${boardList.searchType eq 'title_content' ? 'selected' : ''}>제목+내용</option>
								</select>
							</div>
